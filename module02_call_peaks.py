...
$py_exe $macs2_exe callpeak -t $treat_bed                 -c $ctrl_bed -f BED -n ${name_prefix}_VS_Input     -g mm -p $pvalue --to-large --nomodel --extsize $shift_size -B
sh $get_psudoCount $treat_bed
$py_exe $macs2_exe callpeak -t $treat_bed.pr1.tagAlign.gz -c $ctrl_bed -f BED -n ${name_prefix}.pr1_VS_Input -g mm -p $pvalue --to-large --nomodel --extsize $shift_size -B
$py_exe $macs2_exe callpeak -t $treat_bed.pr2.tagAlign.gz -c $ctrl_bed -f BED -n ${name_prefix}.pr2_VS_Input -g mm -p $pvalue --to-large --nomodel --extsize $shift_size -B
      """
...
$py_exe $macs2_exe callpeak --broad -t $treat_bed -c $ctrl_bed -f BED -g mm --outdir $out_dir -n $name_prefix -p $pvalue -B
      """
